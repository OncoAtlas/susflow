...
> Preliminary data are available for recent years — use `preliminary=True`.
> Exact coverage varies by disease. Use `sinan.list_files(disease="CODE")` to confirm available years.
